          ...
          $(el).filter(function () {
              ...
              atOptions.beforePageContent = function (data) {
                if ( data.pageCount === 1 ) {
                  ...
                  $.each(all, function () {
                    var row = this;
                    if ( row.height > 0 ) {
                      row.height += (2 - FONT_ROW_RATIO) / 2 * 2;//row.cells[0].styles.fontSize;//row.styles.fontSize;
                      data.table.height += (2 - FONT_ROW_RATIO) / 2 * 2;//row.cells[0].styles.fontSize;//row.styles.fontSize;
                    }
                  });
                }
              };
            ...
            if ( typeof atOptions.createdHeaderCell !== 'function' ) {
              ...
              atOptions.createdHeaderCell = function (cell, data) {
                ...
                cell.styles = $.extend({}, data.cell.styles);//data.row.styles);
