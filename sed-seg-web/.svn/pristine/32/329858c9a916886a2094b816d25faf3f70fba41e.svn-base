				...
				<div class="row">
					<div class="col-lg-12">
						...
						<table id="mytable"
							...
							<c:forEach var="opcionform" items="${opcionforms}">
								<tr>
									...
									<td><fmt:formatDate pattern="dd/MM/yyyy"
											value="${opcionform.fechaModificacion}" /></td>
									<td><spring:url
											value="/opcionform/${opcionform.codSistema},${opcionform.codModulo},${opcionform.codFormulario}"
											var="verUrl" /> <spring:url
											value="/opcionform/delete/${opcionform.codSistema},${opcionform.codModulo},${opcionform.codFormulario}"
											var="deleteUrl" /> <spring:url
											value="/opcionform/update/${opcionform.codSistema},${opcionform.codModulo},${opcionform.codFormulario},0"
											var="updateUrl" /> <spring:url
											value="/opcionform/update/${opcionform.codSistema},${opcionform.codModulo},${opcionform.codFormulario},1"
											var="updateTreeUrl" />
										<sed:seguridad accion="/opcionformVISUALIZAR">
										...
										<sed:seguridad accion="/opcionformMODIFICAR">
											<button class="close-image btn btn-default"
										...
										<sed:seguridad accion="/opcionformELIMINAR">
