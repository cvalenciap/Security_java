...
//          codeview: 'Code View'
  ...
  var Renderer = function () {
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      var $editable = $('<div style="height: 300px;" onkeypress="return (this.innerText.length <= 500)" class="note-editable panel-body" contentEditable="' + isContentEditable + '"></div>').prependTo($editingArea);
