						...
						<form:form class="form-horizontal" method="post" id="formid"
							...
							<spring:bind path="desRazon">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									...
									<div class="col-sm-8">
										<form:input path="desRazon" rows="2" maxlength="40"
											class="form-control" id="desRazon"
											placeholder="RAZÓN SOCIAL"
											onkeypress="return alphaNumericSpaceOnly(event);" readonly="true" />
							...
							<spring:bind path="desRazonCorta">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									...
									<div class="col-sm-8">
										<form:input path="desRazonCorta" rows="2" maxlength="40"
											class="form-control" id="desRazonCorta"
											placeholder="RAZÓN SOCIAL ABREVIATURA"
											onkeypress="return alphaNumericSpaceOnly(event);" readonly="true"/>
							...
							<spring:bind path="direccion">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									...
									<div class="col-sm-8">
										<form:input path="direccion" rows="2" maxlength="40"
							...
							<div class="form-group ${status.error ? 'has-error' : ''}">
								<c:choose>
									<c:when test="${contratistaForm['readOnly']}">
										<spring:bind path="codDocRazon">
											...
											<div class="col-sm-3">
												<form:input path="codDocRazon" type="text" maxlength="50"
													class="form-control" id="codDocRazon"
													placeholder="TIPO DOCUMENTO" readonly="true" />
											</div>
										</spring:bind>
									</c:when>
									<c:otherwise>
										<spring:bind path="codDocRazon">
											<label class="col-sm-3 control-label">Tipo y Nro.Documento(*)</label>
											<div class="col-sm-3">
												<form:select path="codDocRazon" class="form-control" disabled="true">
								...
								<spring:bind path="nroDocRazon">
									<div class="col-sm-4">
										<form:input path="nroDocRazon" type="text" maxlength="50"
							...
							<spring:bind path="desRepresentante">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									...
									<div class="col-sm-8">
										<form:input path="desRepresentante" rows="2" maxlength="40"
								...
								<c:choose>
									<c:when test="${contratistaForm['readOnly']}">
										<spring:bind path="codDocRepresentante">
											<label class="col-sm-3 control-label">Tipo y Nro.Documento(*)</label>
											<div class="col-sm-3">
												<form:input path="codDocRepresentante" type="text" maxlength="50"
									...
									<c:otherwise>
										<spring:bind path="codDocRepresentante">
											<label class="col-sm-3 control-label">Tipo y Nro.Documento(*)</label>
											<div class="col-sm-3">
												<form:select path="codDocRepresentante" class="form-control" disabled="true">
													<form:option value="-1" label="--- Select ---" />
													<form:options items="${tiposDocumento}" />
												</form:select>
							...
							<spring:bind path="correo">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									...
									<div class="col-sm-8">
										<form:input path="correo" rows="2" maxlength="40"
											class="form-control" id="correo"
											placeholder="CORREO ELECTRÓNICO"
											onkeypress="return ValidEmail(event);" readonly="true"/>
							...
							<spring:bind path="telefono">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									...
									<div class="col-sm-8">
										<form:input path="telefono" rows="2" maxlength="40"
											class="form-control" id="telefono"
											placeholder="TELEFONOS"
											onkeypress="return checkOnlyDigits(event);" readonly="true" />
								...
								<c:otherwise>
									<spring:bind path="codEstado">
										<div class="form-group ${status.error ? 'has-error' : ''}">
											<label class="col-sm-3 control-label">Estado(*)</label>
											<div class="col-sm-3">
												<form:select path="codEstado" class="form-control" disabled="true">
													<form:options items="${estados}" />
												</form:select>
												<form:errors path="codEstado" class="control-label" />
											</div>
