...
//         }
		...
		//"displayLength": 5,
		"ajax": {
        	"url" : "${pageContext.request.contextPath}/contratista/getContratistaListado",
        	"data": function ( d ) {
   	...
   	$('#mytable1 tbody').on('click', '.btn-view', function (e) {
     	...
     	var url = "${pageContext.request.contextPath}/contratista/" + data[0];
     	$('#spinner').show();
     	console.log(url);
	...
	$('#mytable1 tbody').on('click', '.btn-update', function (e) {
		var data = table.row( $(this).parents('tr') ).data();
		var url = "${pageContext.request.contextPath}/contratista/update/" + data[0];
		$('#spinner').show();
		$(location).attr('href',url);
  	});
	...
	$('#mytable1 tbody').on('click', '.btn-delete', function (e) {
		var data = table.row( $(this).parents('tr') ).data();
		var url = "${pageContext.request.contextPath}/contratista/delete/" + data[0];
		$.confirm({
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<h3 style="text-decoration: underline">
							...
							<sed:seguridad accion="/contratistaCREAR">
								<button class="btn btn-primary pull-right"
									onclick="location.href='contratista/add'">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 form-group no-padding">
						...
						<div class="col-md-12 no-padding">
							<div class="col-md-2 col-sm-3 col-xs-2 no-padding form-group-sm">
								...
								<label for="chkCodigo" class="control-label label-check" >Código</label>
							</div>
							<div class="col-md-2 col-sm-3 col-xs-3 no-padding">	
								<input type="radio" name="chkBusqueda" id="chkDescri" value="D"/>
								<label for="chkDescri" class="control-label label-check" >Descripción</label>
							</div>
						...
						<spring:url value="${pageContext.request.contextPath}/contratista"
							var="userActionUrl" />
