...
//    	cadena=URLDecoder.decode(cadena, "UTF-8");
    ...
    public static <T> T convertirCadenaJsonPostAObjeto(String cadena, Class<T> clase) throws UnsupportedEncodingException{        
  ...
  //Se utiliza jackson debido a que con gson se tuvo problemas con los numericos
    public static String convertirObjetoACadenaJsonMapper(Object cadena) throws UnsupportedEncodingException{        
  ...
  //Se utiliza jackson debido a que con gson se tuvo problemas con los numericos
    public static <T> T convertirCadenaJsonPostAListObjeto(String cadena, Class<T> clase) throws UnsupportedEncodingException{        
    ...
    public  static <T> T convertirObjetoaMapString(Object objeto) throws JsonParseException, JsonMappingException, IOException, UnsupportedEncodingException{
    	try {
    		//String ObjetoJSON = convertirObjetoACadenaJson(objeto);
